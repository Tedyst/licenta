...
<div class="hero bg-base-200">
	<div class="hero-content flex-col">
		<div class="text-center lg:text-left">
			<p class="py-6">Here you can delete a Mongo database from project.</p>
		</div>
		<div class="card w-108 bg-base-100 shadow-xl bordered">
			<div class="card-body">
				...
				{/if}
				<h2 class="card-title">Delete the Mongo database</h2>
				<p class="text-center">
					Are you sure you want to delete the Mongo database? This action is irreversible.
				</p>
