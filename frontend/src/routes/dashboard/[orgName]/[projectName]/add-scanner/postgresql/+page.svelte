...
<div class="hero bg-base-200">
	<div class="hero-content flex-col">
		<div class="text-center lg:text-left">
			<p class="py-6">
				Here you can add a PostgreSQL database to your project. Make sure that the PostgreSQL server
		...
		<div class="card w-108 bg-base-100 shadow-xl bordered">
			<div class="card-body">
				...
				{/if}
				<h2 class="card-title">Add a PostgreSQL database</h2>
				<form autocomplete="off" method="POST" use:enhance class="flex flex-col gap-1">
					...
					<BaseCreateDatabase fields={['hostname', 'port', 'username', 'password', 'database']} />
				</form>
			</div>
		</div>
	</div>
