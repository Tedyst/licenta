...
<div class="hero bg-base-200">
	<div class="hero-content flex-col">
		<div class="text-center lg:text-left">
			<p class="py-6">
				Here you can edit a Docker source. Docker sources are used to scan Docker images for
				secrets. You can configure the image URL, and other settings here. All layers will be
				scanned for secrets.
			</p>
		</div>
		<div class="card w-108 bg-base-100 shadow-xl bordered">
			<div class="card-body">
				...
				{/if}
				<h2 class="card-title">Edit the Docker Secret Scanner</h2>
				<form
					autocomplete="off"
					method="POST"
					use:enhance={() => {
				...
				>
					...
					<BaseCreateDatabase
						...
						initialValues={{
							image: data.currentSource.docker_image,
