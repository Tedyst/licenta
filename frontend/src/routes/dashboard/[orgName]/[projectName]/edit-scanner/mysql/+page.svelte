...
<div class="hero bg-base-200">
	<div class="hero-content flex-col">
		<div class="text-center lg:text-left">
			<p class="py-6">
				Here you can edit a MySQL database from project. Make sure that the MySQL server is running
				and that you have the necessary credentials to connect to it.
				<br />
		...
		<div class="card w-108 bg-base-100 shadow-xl bordered">
			<div class="card-body">
				...
				{/if}
				<h2 class="card-title">Edit the MySQL database</h2>
				<form
					autocomplete="off"
					method="POST"
					use:enhance={() => {
